...
router.post('/', async (req, res) => {
    ...
    try {
        const pool = await poolPromise;
        await pool.request()
            .input('ho_ten', mssql.NVarChar, ho_ten)  // Chuyển sang NVarChar
            .input('so_dien_thoai', mssql.NVarChar, so_dien_thoai)  // Chuyển sang NVarChar
            .input('dia_chi', mssql.NVarChar, dia_chi)  // Chuyển sang NVarChar
            .input('can_cuoc', mssql.NVarChar, can_cuoc)  // Chuyển sang NVarChar
